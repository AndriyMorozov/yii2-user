...
namespace polucorus\user\controllers;

use polucorus\user\Finder;
use polucorus\user\models\RecoveryForm;
use polucorus\user\models\Token;
use polucorus\user\traits\AjaxValidationTrait;
use polucorus\user\traits\EventTrait;
...
class RecoveryController extends Controller
{
     ...
     * Triggered with \polucorus\user\events\FormEvent.
     */
     ...
     * Triggered with \polucorus\user\events\ResetPasswordEvent. May not have $form property set.
     */
     ...
     * Triggered with \polucorus\user\events\ResetPasswordEvent.
     */
