...
```php
'user' => [
    'class' => \polucorus\user\Module::className(),
    'controllerMap' => [
        'registration' => [
            'class' => \polucorus\user\controllers\RegistrationController::className(),
            'on ' . \polucorus\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function ($e) {
...
```php
\yii\base\Event::on(
    \polucorus\user\controllers\RegistrationController::className(),
    \polucorus\user\controllers\RegistrationController::EVENT_AFTER_CONFIRM,
    function () {        
