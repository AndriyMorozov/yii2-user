...
```php
class User extends \polucorus\user\models\User
{
...
You should override view file `@polucorus/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
