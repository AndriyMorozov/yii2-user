...
```php
'facebook' => [
    'class'        => 'polucorus\user\clients\Facebook',
    'clientId'     => 'APP_ID',
...
```php
'twitter' => [
    'class'          => 'polucorus\user\clients\Twitter',
...
```php
'google' => [
    'class'        => 'polucorus\user\clients\Google',
    'clientId'     => 'CLIENT_ID',
...
```php
'github' => [
    'class'        => 'polucorus\user\clients\GitHub',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
],
```
...
```php
'vkontakte' => [
    'class'        => 'polucorus\user\clients\VKontakte',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
]
```
...
```php
'yandex' => [
    'class'        => 'polucorus\user\clients\Yandex',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
```php
'linkedin' => [
    'class'        => 'polucorus\user\clients\LinkedIn',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
use polucorus\user\controllers\SecurityController; 
